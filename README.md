# CNNs_Net
Create the CNN mainstream network framework through Tensorflow, including LeNet, VGG, AlexNet,GoogleNet series(InceptionV1-V4); Test using MNIST and CIFAR data
